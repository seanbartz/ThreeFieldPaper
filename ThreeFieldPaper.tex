...
\be
\cS_E=\frac{1}{16\pi G_5} \int d^5x \sqrt{-\tilde{g}}\left(\tilde{R}-\thalf\partial_\mu\phi\partial^\mu\phi -\thalf\partial_\mu\chi\partial^\mu\chi -\thalf\partial_\mu G\partial^\mu G - \tilde{V}(\phi,\chi,G)\right).
\ee
...
\be
\frac{\partial \Delta U}{\partial \chi} = \frac{\partial \Delta U}{\partial G} = 0,
\ee
...
\be
\Delta U\left(\phi\right) = \alpha \phi e^{-\left(\phi-b\right)^2/c } .
\ee
The best-fit values for these parameters are shown in Table \ref{tabFit}.

\begin{figure}[htb]
\center{\includegraphics[width=300pt]{deltaU.eps}}
\caption{\textit{Plot of the ``extra" term in the potential, $\Delta U(\phi)$.}}
\label{figdeltaU}
\end{figure}
...
$c$ & 0.6819\\ %plus/minus .0007
  \hline
\end{tabular}
\caption{The parameters for the fitting to $\Delta U$}
\end{center}
\end{table}
...
\bibliographystyle{phys-rev}
\bibliography{ThreeField}
