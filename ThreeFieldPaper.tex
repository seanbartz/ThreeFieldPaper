...
It is noted that the model proposed by Huang and Li accurately models the non-restoration of chiral symmetry using a model with only two background fields, but their model differs from the work presented here in several respects.
...
$b$ & 0.9219  \\ %plus/minus .0004
$c$ & 0.6819\\ %plus/minus .0007
  \hline
\end{tabular}
...
\caption{\textit{$a_1$ meson spectrum.}}
\end{figure}

\begin{figure}[htb]
\center{\includegraphics[width=300]{rho.eps}}
\caption{\textit{$\rho$ meson spectrum.}}
\label{figRho}
\end{figure}
